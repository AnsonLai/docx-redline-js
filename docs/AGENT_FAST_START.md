...
2. For semantic drafting such as “make this provision mutual,” extract enough
   ...
   Search is case-insensitive; follow `selection.hint` and `selection.nextAfter`, and report `humanReference`. Apply once with a UTF-8 operations file or serializer-backed stdin:
